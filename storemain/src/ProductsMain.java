...
class ProductsMain extends JInternalFrame implements ActionListener,MouseListener,KeyListener{
	...
	private void productsFrame(){
		...
		bAdd=new JButton(new ImageIcon("icon/Add.png"));
		bAdd.setBounds(20,270,100,60);
		c.add(bAdd);
		
		bNew=new JButton(new ImageIcon("Png1/File Types/Default.png"));
		bNew.setBounds(110,270,100,60);
		c.add(bNew);
		
		bDelete=new JButton(new ImageIcon("Png1/Desktop/delete.png"));
		bDelete.setBounds(210,270,100,60);
		c.add(bDelete);
		
		bUpdate=new JButton(new ImageIcon("PNG/refresh.png"));
		bUpdate.setBounds(20,340,100,60);
		c.add(bUpdate);
		
		bFind=new JButton(new ImageIcon("PNG/search.png"));
		bFind.setBounds(110,340,100,60);
		c.add(bFind);
		
		bClose=new JButton(new ImageIcon("icon/close.png"));
		bClose.setBounds(210,340,100,60);
		c.add(bClose);
		
		bPrint=new JButton(new ImageIcon("icon/printer.png"));
